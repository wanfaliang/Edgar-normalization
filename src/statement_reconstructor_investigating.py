# use this file to investigate statement reconstruction to understand multiple identical accounts of balance sheet
# some companies have the same accounts come up a couple  of times, and our reconstructed balance sheets only capture one of the identical accounts, 
# resulting in unbalanced balance sheets. Although our current solution of using 'other_' items works, but we can do
#  better. Noteably, such situations have something in common, they all involved receivables or payables in the  
#  nature of finance, long term or short term. Companies are such as Boeing, Caterpillar, CONOCOPHILLIPS, or      
#  BEST BUY, involving financed sales or purchase. According to the GAAP, such receivables and payables should   
#  be presented separately. That's my understanding, we need to investigate.
